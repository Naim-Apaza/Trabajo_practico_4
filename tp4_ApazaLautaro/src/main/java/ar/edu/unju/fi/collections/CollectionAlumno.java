...
public class CollectionAlumno {
	...
	public static List<Alumno> getAlumnos() {
		if (alumnos.isEmpty()) {
			alumnos.add(new Alumno("445544", "Lucas", "Romero", "luquitas@gmail", "38848434343",
					LocalDate.of(2005, 2, 21), "Jujuy", "APU002233"));
			alumnos.add(new Alumno("3232", "Ivan", "Centinela", "Centi@gmail", "388433222", LocalDate.of(2008, 5, 3),
					"Jujuy", "APU003221"));
			alumnos.add(new Alumno("233323", "Jose", "Condori", "condor@gmail", "38848422233",
					LocalDate.of(1999, 6, 11), "Jujuy", "APU0023332"));
		}
	...
	public static void modificarAlumno(Alumno alumno) {
		for (Alumno a : alumnos) {
			if (a.getDni().equalsIgnoreCase(alumno.getDni())) {
				...
				a.setEmail(alumno.getDomicilio());
